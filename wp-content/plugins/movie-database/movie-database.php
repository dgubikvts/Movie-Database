...
{
    require_once plugin_dir_path(__FILE__) . 'includes/core/class-movie-database-activator.php';
    MVDB_Activator::activate();
}

function mvdb_deactivate(): void
{
    require_once plugin_dir_path(__FILE__) . 'includes/core/class-movie-database-deactivator.php';
...
require_once MVDB_PLUGIN . 'includes/core/class-movie-database.php';
$mvdb = new MVDB_MovieDatabase();
$mvdb->run();